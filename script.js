...
const photoList = ["gallery_04 1", "exams-image2", "exams-image3", "exams-image4"];// holder Array med billed file navn
...
function validate(e) {//e is function parameter
    const email = e.target.elements.email.value;
    const name = e.target.elements.name.value;
    const message = e.target.elements.message.value;
    if (name.length === 0) {//same value, same data type
